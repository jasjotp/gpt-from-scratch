...
The first integer sequence in the first block for example, has multiple examples packed into it as all of these characters follow each other. The tensor of the first block size's sequence will be trained to make a prediction at every one of the positions in the tensor. 
